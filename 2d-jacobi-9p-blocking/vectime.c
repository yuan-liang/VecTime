                        ...
                        if (myyb <= 2 * VECLEN ) {
						    ...
						    for (x = xmin + XSLOPE; x < xmax - STRIDE * VECLEN - 1; x++) {
						    	...
						    	for (; y <= myybeg - VECLEN + 1 + myyb - VECLEN; y += VECLEN) {
									...
									vload(v_x_minus_2, BV0[y - ( myybeg - VECLEN + 1 ) + 1][0]);
									vload(v_x_plus_2,  BV2[y - ( myybeg - VECLEN + 1 ) + 1][0]);
									vload(v_center_2,  BV1[y - ( myybeg - VECLEN + 1 ) + 1][0]);
									vstore(BV0[y - ( myybeg - VECLEN + 1 )][0], v_center_3);
									...
									vload(v_x_minus_3, BV0[y - ( myybeg - VECLEN + 1 ) + 2][0]);
									vload(v_x_plus_3,  BV2[y - ( myybeg - VECLEN + 1 ) + 2][0]);
									vload(v_center_3,  BV1[y - ( myybeg - VECLEN + 1 ) + 2][0]);
									vstore(BV0[y - ( myybeg - VECLEN + 1 ) + 1][0], v_center_0);
									...
									vload(v_x_minus_0, BV0[y - ( myybeg - VECLEN + 1 ) + 3][0]);
									vload(v_x_plus_0,  BV2[y - ( myybeg - VECLEN + 1 ) + 3][0]);
									vload(v_center_0,  BV1[y - ( myybeg - VECLEN + 1 ) + 3][0]);
									...
									v_center_1 = (y > myybeg - VECLEN + 1 + myyb - VECLEN -VECLEN) ?  \
												...
												: _mm256_loadu_pd(&BV1[y - ( myybeg - VECLEN + 1 ) + 4][0]);
									v_x_plus_1 = (y > myybeg - VECLEN + 1 + myyb - VECLEN -VECLEN) ?  \
												...
												: _mm256_loadu_pd(&BV2[y - ( myybeg - VECLEN + 1 ) + 4][0]);
									v_x_minus_1 = (y > myybeg - VECLEN + 1 + myyb - VECLEN -VECLEN) ?  \
												(_mm256_set_pd(	B[(t + 1) % 2][x - XSLOPE][y + VECLEN], \
																B[(t) % 2][x - XSLOPE + STRIDE][y + VECLEN + 1], \
																B[(t + 1) % 2][x - XSLOPE + STRIDE * 2][y + VECLEN + 2], 
																B[(t) % 2][x - XSLOPE + STRIDE * 3][y + VECLEN + 3])) \
												: _mm256_loadu_pd(&BV0[y - ( myybeg - VECLEN + 1 ) + 4][0]);
									vstore(BV0[y - ( myybeg - VECLEN + 1 ) + 3][0], v_center_2);
						    ...
						    for (; x < xmax - STRIDE * VECLEN + 2; x++) {
						    	...
						    	for (y = myybeg - VECLEN + 1; y <= myybeg - VECLEN + 1 + myyb - VECLEN; y += VECLEN) {
									...
									v_center_0 = _mm256_loadu_pd(&Btmp[x - (xmax - STRIDE * VECLEN - 1)][(y - (myybeg - VECLEN + 1))][0]);
									v_center_1 = _mm256_loadu_pd(&Btmp[x - (xmax - STRIDE * VECLEN - 1)][(y - (myybeg - VECLEN + 1)) + 1][0]);
									v_center_2 = _mm256_loadu_pd(&Btmp[x - (xmax - STRIDE * VECLEN - 1)][(y - (myybeg - VECLEN + 1)) + 2][0]);
									v_center_3 = _mm256_loadu_pd(&Btmp[x - (xmax - STRIDE * VECLEN - 1)][(y - (myybeg - VECLEN + 1)) + 3][0]);  

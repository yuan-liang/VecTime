...
void vectime(int * B, int NX, int NY, int T, int xb, int yb, int tb);
void naive_vector(int * B, int NX, int NY, int T, int xb, int yb, int tb);
int checkresult( int NX, int NY, int (* A)[ NY+2*YSTART], int (* B)[ NY+2*YSTART] );
